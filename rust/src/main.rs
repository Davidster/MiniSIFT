...
fn main() {
    ...
    // sift::do_sift(&mut rainier_image_tree_1);
    // sift::do_sift(&mut rainier_image_tree_2);

    // if let Some(img_1_key_points) = rainier_image_tree_1.key_points {
    //     if let Some(img_2_key_points) = rainier_image_tree_2.key_points {
    //         let sorted_key_point_pairs =
    //             sift::get_sorted_key_point_pairs(&img_1_key_points, &img_2_key_points);
